...
router.post('/register',
    ...
    body('address', 'Address is required!').isLength({ max: 20 }).withMessage('Address must be not more than 20 characters long!'),
    ...
    async (req, res) => {
        ...
        try {
            ...
            console.log(errors);
            await req.auth.register(  req.body.username.trim(), req.body.address.trim(), req.body.password.trim());
